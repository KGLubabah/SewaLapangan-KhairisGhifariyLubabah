            ...
            <div className="container">
                <div className="card mt-2">
                    ...
                    <div className="card-body">
                                    ...
                                    return (
                                        <tr key={item.id_sewa} >
                                            ...
                                            <td>
                                                ...
                                                <button className="m-1 btn btn-sm btn-warning" onClick={() => this.Decline(item.id_sewa)}>
                        ...
                        {/* form modal lapangan*/}
                        <Modal id="modal_sewa" title="Form Sewa" bg_header="dark" text_header="info">
                            ...
                            <button onClick={() => console.log(this.state)} className="btn btn-dark btn-block">
